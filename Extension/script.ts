...
const queryClient = document.getElementById('app').__vue_app__._context.app._context.provides.VUE_QUERY_CLIENT; //extracting queryClient then assign to a constant
...
const queryHasBeenSeen = (key: string): boolean => queryStorage.has(key);
const callback = (event: object): void => {
